...
export class Default1700521044559 implements MigrationInterface {
    name = 'Default1700521044559'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userName\` varchar(25) NOT NULL, \`userCpf\` varchar(25) NOT NULL, \`userEmail\` varchar(25) NOT NULL, \`userAddress\` varchar(70) NOT NULL, \`DateCreate\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
